...
int main() {
    ...
    objs = {
       ...
       Object(glm::vec3(-15000, 650, -350), glm::vec3(0, 0, 2500), 5.97219 * pow(10, 24), 5515, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f)),
       Object(glm::vec3(15000, 650, -350), glm::vec3(0, 0, -2500), 5.97219 * pow(10, 24), 5515, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f)),
       Object(glm::vec3(0, 0, -350), glm::vec3(0, 0, 550), 1.989 * pow(10, 27), 5515, glm::vec4(1.0f, 0.929f, 0.176f, 1.0f), true),
       // Sun
...
GLFWwindow* StartGLU() {
    ...
    GLFWwindow* window = glfwCreateWindow(1600, 800, "3D_TEST", NULL, NULL);
    if (!window) {
